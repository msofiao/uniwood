 ...
 * @returns
 */
export function projectsCustomMultipartConsumer(req, res) {
...
export function projectPostOnresponseHander(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * Remove Files From Temp Folder
 */
export function projectPutOnResponeseHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        // Remove Files From Temp Folder
