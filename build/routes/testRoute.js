...
export function TestRoute(instance, _options, done) {
    instance.post("/test", { preHandler: arbitraryMultipartConsumer }, (req, res) => __awaiter(this, void 0, void 0, function* () {
        moveFile(req.body.media, "tmp", "public");
        return res.send({ message: "success", body: Object.assign({}, req.body) });
    }));
    done();
}
